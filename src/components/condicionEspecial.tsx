...
const CondicionEspecial: React.FC<CondicionEspecialProps> = ({
  ...
  // ====== LIMPIEZA COMPLETA DEL PDF DE CONDICIÓN ======
  const clearCondicionFile = () => {
    if (fileInputRef.current) fileInputRef.current.value = "";
    handleFileChange(null); // limpia estado en padre
  ...
  // ====== onChange del SELECT: si se elige "Ninguno", borra archivo y oculta ícono ======
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <TextField
        ...
        onChange={handleSelectChange} // 👈 intercepta para limpiar
        InputProps={{
          // 👇 Ícono solo si hay una condición seleccionada
          endAdornment:
            formData.tipoCondicion ? (
              <InputAdornment position="end" sx={{ mr: 1 }}>
                <Tooltip
                  title="Adjunte el PDF que acredite la condición del contribuyente."
                  arrow
                >
                  <IconButton
                    color="success"
      ...
      >
        ...
        <MenuItem value="adultoMayor">Adulto Mayor</MenuItem>
      </TextField>
