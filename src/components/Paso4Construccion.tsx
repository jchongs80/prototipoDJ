...
useEffect(() => {
  ...
  // 👇 Solo se setea la PRIMERA vez
  setInitialPisosCount((prev) =>
    prev === 0
      ? pisosProp && pisosProp.length > 0
        ? pisosProp.length
        : nuevosPisos.length
...
}, [pisosProp, obrasProp, onActualizarConstruccion]);
